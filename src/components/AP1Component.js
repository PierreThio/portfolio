...
export default function AP1Component() {
  return (
    <React.Fragment>
        ...
        <a href="https://github.com/PierreThio/AP1" target="blank" className="z-20">
        ...
        <p className="absolute left-1/2 top-1/10 -translate-x-1/2 translate-y-full font-bold">Septembre-Novembre 2022</p>
