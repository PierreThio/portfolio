...
import SwiperIcon from "../../public/swiper.svg";
    ...
    <React.Fragment>
        ...
        <div className="w-3/12 flex flex-col border-4 border-blue-500 p-4 rounded-xl">
            ...
            <div className="flex justify-between mt-4">
                <Image className="h-12 w-12" src={HtmlIcon} alt="HtmlIcon"/>
                <Image className="h-12 w-12" src={CssIcon} alt="CssIcon"/>
                <Image className="h-12 w-12" src={ReactIcon} alt="ReactIcon"/>
                <Image className="h-12 w-12" src={JavascriptIcon} alt="JavascriptIcon"/>
                <Image className="h-12 w-12" src={GSAPIcon} alt="GSAPIcon"/>
                <Image className="h-12 w-12" src={SwiperIcon} alt="SwiperIcon"/>
                <Image className="h-12 w-12" src={NextJsIcon} alt="NextJsIcon"/>
            </div>
        </div>

        <a href="https://github.com/PierreThio/portfolio" target="blank" className="z-20">
        ...
        <p className="absolute left-1/2 top-1/10 -translate-x-1/2 translate-y-full font-bold">Avril-Mai 2024</p>
