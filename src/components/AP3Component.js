...
import TwigIcon from "../../public/twig.svg";
import VuejsIcon from "../../public/vuejs.svg";
import JavascriptIcon from "../../public/javascript.svg";

export default function AP3Component() {
  return (
    <React.Fragment>
        ...
        <div className="w-3/12 flex flex-col border-4 border-blue-500 p-4 rounded-xl">
            ...
            <div className="flex justify-between mt-4">
                <Image className="h-12 w-16" alt="HtmlIcon" src={HtmlIcon}/>
                <Image className="h-12 w-16" alt="CssIcon" src={CssIcon}/>
                <Image className="h-12 w-16" alt="JavascriptIcon" src={JavascriptIcon}/>
                <Image className="h-12 w-16" alt="phpIcon" src={PhpIcon}/>
                <Image className="h-12 w-12" src={SymfonyIcon} alt="symfonyIcon"/>
                <Image className="h-12 w-12" src={TwigIcon} alt="twigIcon"/>
                <Image className="h-12 w-12" src={VuejsIcon} alt="vuejsIcon"/>
            </div>
        </div>
        ...
        <p className="absolute left-1/2 top-1/10 -translate-x-1/2 translate-y-full font-bold">Septembre-Décembre 2023</p>
