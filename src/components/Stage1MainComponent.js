...
export default function Stage1MainComponent() {
    ...
    <Fragment>
        ...
        <div className="flex w-full h-5/6 justify-around items-center ">
            <div className="w-6/12 flex justify-center rounded-3xl">
                <swiper-container>
                    <swiper-slide><div className="h-full"><img className="object-cover h-full" src="Stage1/1.png" alt="capture1"/></div></swiper-slide>
                </swiper-container>
            </div>
        ...
        <p className="absolute left-1/10 top-1/10 -translate-x-1/2 translate-y-full font-bold">Juin 2023</p>
