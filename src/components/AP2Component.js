...
export default function AP2Component() {
  return (
    <React.Fragment>
        ...
        <a href="https://github.com/PierreThio/AP-RISSER" target="blank" className="z-20">
        ...
        <p className="absolute left-1/2 top-1/10 -translate-x-1/2 translate-y-full font-bold">Mars-Avril 2023</p>
